...
namespace ConsoleApp2
{
    class Program
    {
        //zdeklarowanie globalnie zmiennych
        static int Kumulacja;
        static int START = 40;
        static Random rnd = new Random();
        //Funkcja MAIN (zmienne lokalne)
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                do
                {
                    ...
                    dzien++;
                    int losow = 0;
                    List<int[]> kupon = new List<int[]>(); //tworzenie obiektu Listy (Listy są zawsze dynamiczne)
                    do
                    {
                        Console.Clear();
                ...
                } while (pieniadze >= 3 && wybor != ConsoleKey.D3); //kupon kosztuje 3zł wiec dlatego trzy
        ...
        private static int Sprawdz(List<int[]> kupon)
        {
            ...
            if (trafione[0] > 0)
            {
                wartosc = trafione[0] * 24; //za 3 otrzymuje sie 24 zł zawsze dlatego 24
        ...
        {
            int[] wygrane = new int[4]; //4 możliwości wygrania w grze
            int i = 0;//zmienna pomocznica;
            Console.WriteLine("\n\nTWÓJ KUPON:");
        ...
        private static void WyswietlKupon(List<int[]> kupon)
        {
            ...
            else 
            {
                ...
                foreach (int[] los in kupon) 
                {
                    ...
                    Console.WriteLine(); // to jest enter aby oddzielić kupony od siebie
                }
            }
        }
    }
